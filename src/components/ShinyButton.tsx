...
export const ShinyButton = ({
  ...
  return (
    <Link
      href={href ?? "#"}
      className={cn(
        "group relative flex transform items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-md border border-white bg-brand-700 px-8 text-base/7 font-medium text-white ring-offset-2 transition-all duration-300 hover:ring-2 hover:ring-brand-700 focus:outline-none focus:ring-2 focus:ring-offset-2",
        className,
      )}
      {...props}
    >
